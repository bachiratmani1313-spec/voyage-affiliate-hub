...
export default function FlightWidget() {
  useEffect(() => {
    const scriptId = "tp-script-7879";
    if (!document.getElementById(scriptId)) {
      const script = document.createElement("script");
      script.id = scriptId;
      script.src = "https://c121.travelpayouts.com/content?promo_id=7879&shmarker=704469&locale=fr&currency=eur&powered_by=true";
      script.async = true;
    ...
    <section id="vols" data-testid="flight-widget-section" className="py-20 px-6 lg:px-12 max-w-7xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-400 text-base max-w-xl mx-auto" style={{ fontFamily: "'Outfit', sans-serif" }}>
          Comparez des centaines de compagnies aériennes pour trouver le meilleur prix en temps réel.
        </p>
      </div>
      ...
      >
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: `<tp-cascoon id="tp-cascoon-flight" data-cascoon-id="7879_0"></tp-cascoon>`,
          }}
        />
